 ...
 */
(function(n){"use strict";function f(n){return new RegExp("(^|\\s+)"+n+"(\\s+|$)")}function e(n,u){var f=t(n,u)?r:i;f(n,u)}var t,i,r,u;"classList"in document.documentElement?(t=function(n,t){return n.classList.contains(t)},i=function(n,t){n.classList.add(t)},r=function(n,t){n.classList.remove(t)}):(t=function(n,t){return f(t).test(n.className)},i=function(n,i){t(n,i)||(n.className=n.className+" "+i)},r=function(n,t){n.className=n.className.replace(f(t)," ")});u={hasClass:t,addClass:i,removeClass:r,toggleClass:e,has:t,add:i,remove:r,toggle:e};typeof define=="function"&&define.amd?define(u):n.classie=u})(window),function(){function n(n){classie.add(n.target.parentNode,"input--filled")}function t(n){n.target.value.trim()===""&&classie.remove(n.target.parentNode,"input--filled")}String.prototype.trim||function(){var n=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g;String.prototype.trim=function(){return this.replace(n,"")}}();[].slice.call(document.querySelectorAll("input.input__field")).forEach(function(i){i.value.trim()!==""&&classie.add(i.parentNode,"input--filled");i.addEventListener("focus",n);i.addEventListener("blur",t)})}();"use strict";var caseSlider=null,blueImpactSlider=null,pagerSlider=null,controlSlider=null;jQuery(function(n){function h(){var t=n("#slideCaseStudy").children().length;t>1&&(caseSlider=n("#slideCaseStudy").bxSlider({controls:!1}))}function r(t,i){var r=n("#slideBlueImpact").children().length<2;blueImpactSlider=n("#slideBlueImpact").bxSlider({pager:r?!1:t?!0:!1,controls:r?!1:i?!0:!1,auto:!0,pause:15e3,speed:1e3,hideControlOnEnd:!0,touchEnabled:r?!1:!0,onSlideAfter:function(){blueImpactSlider.stopAuto();blueImpactSlider.startAuto()}})}function u(t,i){t.off("click.accordion").on("click.accordion",function(){var o=n(this),s=t.selector,u=s.split("-")[1],r=o.closest("[data-"+u+"]"),f=r.find("[data-"+u+"-content]"),e;f.is(":visible")?(r.removeClass("open"),f.slideUp(600)):(e=n("[data-"+u+"].open"),e.length?e.find("[data-"+u+"-content]").slideUp(300,function(){e.removeClass("open");r.addClass("open");f.slideDown(600)}):(r.addClass("open"),f.slideDown(600)),setTimeout(function(){n("body, html").animate({scrollTop:o.offset().top-(n("#header").outerHeight(!0)+10)},600)},600),r.find("[data-slider]").length&&setTimeout(function(){caseSlider?caseSlider.reloadSlider():i();blueImpactSlider?blueImpactSlider.reloadSlider():i()},600))})}var t=n(window).width(),i=n(window).height(),c,o=null,l=null,a=navigator.userAgent.match(/iPad/i)!=null,f=n(".block-contact-us"),e=n("[data-accordion-handler]"),s=n("[data-collapse-handler]"),v=function(){var v=n(window).width(),y=n(window).height(),a;(t!=v||i!=y)&&(t=v,i=y,$viewport=t<=479?0:t<=767?1:t<=991?2:t<=1199?3:t<=1300?4:5,blueImpactSlider&&n.isFunction(blueImpactSlider.destroySlider)&&(blueImpactSlider.destroySlider(),blueImpactSlider=null),c!==$viewport&&($viewport>2?caseSlider&&n.isFunction(caseSlider.destroySlider)&&(caseSlider.destroySlider(),caseSlider=null):caseSlider!==null&&n.isFunction(caseSlider.destroySlider)||h()),$viewport<3?(n(".block-impact").hasClass("open")?(pagerSlider=!0,controlSlider=!1,r(pagerSlider,controlSlider),u(e)):u(e,function(){caseSlider&&n.isFunction(caseSlider.destroySlider)&&(caseSlider.destroySlider(),caseSlider=null);pagerSlider=!0;controlSlider=!1;r(pagerSlider,controlSlider);h()}),s.length&&u(e),n("[data-scroll-space]").css("padding-top",0)):(pagerSlider=!1,controlSlider=!0,r(pagerSlider,controlSlider),n("[data-accordion-handler]").off("click")),t<992&&n(".close-btn").click(function(n){n.preventDefault();history.go(-1)}),c=$viewport,a=n(".items-content").find(".desc"),a.height("auto"),t>=992&&a.setAllToMaxHeight(),f.length&&t<i&&$viewport===2&&o!==null&&o+n('[data-scroll-top="contactus"]').outerHeight(!0)>=l&&(f.hasClass("open")||f.find("[data-accordion-handler]").click()))};n(window).bind("resize",v);n(document).ready(function(){var f=n(".block-sticky-nav"),c,a,l,o;if(f.length){f.affix({offset:{top:n(".sticky-nav").offset().top}});f.on("affixed-top.bs.affix",function(){n("[data-scroll-space]").css("padding-top",0)});f.on("affix.bs.affix",function(){n("[data-scroll-space]").css("padding-top",f.outerHeight(!0))})}c=f.find("li");a=c.find("a");c.on("click",function(){var i=n(this),t=i.find("a").attr("href"),r=t.split("#")[1];window.location.hash=t;n("body, html").stop().animate({scrollTop:n('[data-scroll-top="'+r+'"]').offset().top-f.outerHeight(!0)-10},600)});if(n(".table-responsive").stackcolumns(),n(n(".ul-level1 > li")[3]).addClass("active"),$viewport<3?(u(e,function(){caseSlider&&n.isFunction(caseSlider.destroySlider)&&(caseSlider.destroySlider(),caseSlider=null);blueImpactSlider&&n.isFunction(blueImpactSlider.destroySlider)&&(blueImpactSlider.destroySlider(),blueImpactSlider=null);pagerSlider=!0;controlSlider=!1;h();r(pagerSlider,controlSlider)}),s.length&&u(s)):(pagerSlider=!1,controlSlider=!0,r(pagerSlider,controlSlider)),n("[data-fancybox]").fancybox({helpers:{title:null},beforeShow:function(){n("html").addClass("popup-image");isMobile.phone&&(this.width=t<i?i:t,n(".fancybox-inner").height("auto"))},afterShow:function(){},afterClose:function(){n("html").removeClass("popup-image")}}),l=n(".member-items"),isMobile.phone||isMobile.tablet){l.on("click.member",function(){var t=n(this).data("url");window.location.href=t});n(".close-btn").click(function(n){n.preventDefault();history.go(-1)})}else l.fancybox({type:"inline",maxWidth:800,fitToView:!1,autoSize:!1,width:"80%",autoSize:!1,arrows:!0,openEffect:"none",closeEffect:"none",helpers:{title:null},beforeShow:function(){n("html").addClass("popup-member")},afterShow:function(){},afterClose:function(){n("html").removeClass("popup-member")}});if(o=n(".block-impact"),o.length){var v=n(".title",o).text(),y=n(".casestudy-wrapper"),p=n(".case-showcase",y),w=n(".case-impact"),b=n("p",o).text(),k=n("ul li",w);v.length>1||p.length||k.length||b.length>1?o.css("display","block"):o.remove()}});n(window).load(function(){var i=window.location.hash,r=n(".block-sticky-nav"),u=r.outerHeight(!0),f=n('[data-scroll-top="'+i.split("#")[1]+'"]');r.is(":visible")&&f.length&&setTimeout(function(){n("html, body").animate({scrollTop:n('[data-scroll-top="'+i.split("#")[1]+'"]').offset().top-u-10})},600);t>=992&&n(".items-content").find(".desc").setAllToMaxHeight()});n(window).scroll(function(){var t=n(".block-sticky-nav"),r=t.find("a","li"),i=n(window);t.length&&n("[data-scroll-top]").each(function(){var u=n(this),f=r.filter('[href="#'+u.data("scroll-top")+'"]');(i.scrollTop()+i.height()==n(document).height()||i.scrollTop()>=u.offset().top-t.outerHeight(!0)*2)&&f.closest("li").addClass("active").siblings().removeClass("active")});window.innerHeight<window.innerWidth&&a&&f.length&&(o=n(window).scrollTop(),l=n("[data-scroll-top]",".block-contact-us").offset().top)})});$(function(){$("#submitButton").click(function(){var n=$("#Name").val().trim(),t=$("#Email").val().trim(),i=$("#Phone").val();if(validateForm(n,t,i)!=!1){var r=$("#Job").val(),u=$("#Organization").val(),f=$("#Location").val(),e=$("#Content").val();$.post("/api/ContactUsApi/Post",{Name:n,Job:r,Organization:u,Location:f,Phone:i,Email:t,Content:e},function(n){n==!0?(showPopupResult(SubcribeHeaderSuccess,SubcribeContentSuccess),$("#Name").val(""),$("#Job").val(""),$("#Organization").val(""),$("#Location").val(""),$("#Phone").val(""),$("#Email").val(""),$("#Content").val("")):showPopupResult(ErrorLabel,SubcribeContentError)})}})});
//# sourceMappingURL=coachprofiles.min.js.map
