 ...
 */
(function(n){"use strict";function f(n){return new RegExp("(^|\\s+)"+n+"(\\s+|$)")}function e(n,u){var f=t(n,u)?r:i;f(n,u)}var t,i,r,u;"classList"in document.documentElement?(t=function(n,t){return n.classList.contains(t)},i=function(n,t){n.classList.add(t)},r=function(n,t){n.classList.remove(t)}):(t=function(n,t){return f(t).test(n.className)},i=function(n,i){t(n,i)||(n.className=n.className+" "+i)},r=function(n,t){n.className=n.className.replace(f(t)," ")});u={hasClass:t,addClass:i,removeClass:r,toggleClass:e,has:t,add:i,remove:r,toggle:e};typeof define=="function"&&define.amd?define(u):n.classie=u})(window),function(){function n(n){classie.add(n.target.parentNode,"input--filled")}function t(n){n.target.value.trim()===""&&classie.remove(n.target.parentNode,"input--filled")}String.prototype.trim||function(){var n=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g;String.prototype.trim=function(){return this.replace(n,"")}}();[].slice.call(document.querySelectorAll("input.input__field")).forEach(function(i){i.value.trim()!==""&&classie.add(i.parentNode,"input--filled");i.addEventListener("focus",n);i.addEventListener("blur",t)})}();jQuery(function(n){function u(t){t.off("click.accordion").on("click.accordion",function(){var e=n(this),o=t.selector,i=o.split("-")[1],r=e.closest("[data-"+i+"]"),u=r.find("[data-"+i+"-content]"),f;u.is(":visible")?(r.removeClass("open"),u.slideUp(600)):(f=n("[data-"+i+"].open"),f.length?f.find("[data-"+i+"-content]").slideUp(300,function(){f.removeClass("open");r.addClass("open");u.slideDown(600)}):(r.addClass("open"),u.slideDown(600)),setTimeout(function(){n("body, html").animate({scrollTop:e.offset().top-n("#header").outerHeight(!0)},300)},300))})}var t=n(window).width(),f=n(window).height(),e=null,s=null,h=navigator.userAgent.match(/iPad/i)!=null,r=n(".block-contact-us"),o=n("[data-accordion-handler]"),i=n("[data-collapse-handler]"),c=function(){var h=n(window).width(),c=n(window).height();(t!=h||f!=c)&&(t=h,f=c,$viewport=t<=479?0:t<=767?1:t<=991?2:t<=1199?3:t<=1300?4:5,$viewport<3?(u(o),i.length&&u(i)):(o.off("click.accordion"),i.off("click.accordion")));r.length&&t<f&&$viewport===2&&e!==null&&e+n('[data-scroll-top="contactus"]').outerHeight(!0)>=s&&(r.hasClass("open")||r.find("[data-accordion-handler]").click())};n(window).bind("resize",c);n(document).ready(function(){n(n(".ul-level1 > li")[3]).addClass("active");$viewport<3&&(u(o),i.length&&u(i))});n(window).load(function(){});n(window).scroll(function(){window.innerHeight<window.innerWidth&&h&&r.length&&(e=n(window).scrollTop(),s=n("[data-scroll-top]",".block-contact-us").offset().top)})});$(function(){$("#submitButton").click(function(){var n=$("#Name").val().trim(),t=$("#Email").val().trim(),i=$("#Phone").val();if(validateForm(n,t,i)!=!1){var r=$("#Job").val(),u=$("#Organization").val(),f=$("#Location").val(),e=$("#Content").val();$.post("/api/ContactUsApi/Post",{Name:n,Job:r,Organization:u,Location:f,Phone:i,Email:t,Content:e},function(n){n==!0?(showPopupResult(SubcribeHeaderSuccess,SubcribeContentSuccess),$("#Name").val(""),$("#Job").val(""),$("#Organization").val(""),$("#Location").val(""),$("#Phone").val(""),$("#Email").val(""),$("#Content").val("")):showPopupResult(ErrorLabel,SubcribeContentError)})}})});$(window).load(function(){if(serviceType!=undefined){var n="/api/ServicesApi/GetServices?type="+serviceType+"&pageNodeId="+pageNodeId;$.post(n,function(n){$("#gridservices").html(n);$("#gridservices").is(":empty")&&$("#idservices")!=undefined&&$("#idservices").hide()})}});
