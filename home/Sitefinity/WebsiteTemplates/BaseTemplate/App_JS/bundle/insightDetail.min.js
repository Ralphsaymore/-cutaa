 ...
 */
(function(n){"use strict";function f(n){return new RegExp("(^|\\s+)"+n+"(\\s+|$)")}function e(n,u){var f=t(n,u)?r:i;f(n,u)}var t,i,r,u;"classList"in document.documentElement?(t=function(n,t){return n.classList.contains(t)},i=function(n,t){n.classList.add(t)},r=function(n,t){n.classList.remove(t)}):(t=function(n,t){return f(t).test(n.className)},i=function(n,i){t(n,i)||(n.className=n.className+" "+i)},r=function(n,t){n.className=n.className.replace(f(t)," ")});u={hasClass:t,addClass:i,removeClass:r,toggleClass:e,has:t,add:i,remove:r,toggle:e};typeof define=="function"&&define.amd?define(u):n.classie=u})(window),function(){function n(n){classie.add(n.target.parentNode,"input--filled")}function t(n){n.target.value.trim()===""&&classie.remove(n.target.parentNode,"input--filled")}String.prototype.trim||function(){var n=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g;String.prototype.trim=function(){return this.replace(n,"")}}();[].slice.call(document.querySelectorAll("input.input__field")).forEach(function(i){i.value.trim()!==""&&classie.add(i.parentNode,"input--filled");i.addEventListener("focus",n);i.addEventListener("blur",t)})}();jQuery(function(n){var t=n(window).width(),i=n(window).height(),f=null,o=null,h=navigator.userAgent.match(/iPad/i)!=null,r=n(".block-contact-us"),e=n("[data-accordion-handler]"),u=n("[data-collapse-handler]"),c=function(){var s=n(window).width(),h=n(window).height();(t!=s||i!=h)&&(t=s,i=h,$viewport=t<=479?0:t<=767?1:t<=991?2:t<=1199?3:t<=1300?4:5);$viewport<3?(n(".block-banner").css("padding-top",0),accordion(e),u.length&&accordion(u)):e.off("click.accordion");r.length&&t<i&&$viewport===2&&f!==null&&f+n('[data-scroll-top="contactus"]').outerHeight(!0)>=o&&(r.hasClass("open")||r.find("[data-accordion-handler]").click())},s;n(window).bind("resize",c);n(document).ready(function(){var r,f;$viewport>=3?n(".group-item").setAllToMaxHeight():(accordion(e),u.length&&accordion(u));n(".form-contact").on("submit",function(n){n.preventDefault();showPopupResult("Your question has been submitted","We will send you an email notification once a doctor answers your query.")});r=n(".block-related");r.height()>n(".block-right").height()&&r.addClass("no-affix");n("[data-fancybox]").fancybox({helpers:{title:null},beforeShow:function(){n("html").addClass("popup-image");isMobile.phone&&(this.width=t<i?i:t,n(".fancybox-inner").height("auto"))},afterShow:function(){},afterClose:function(){n("html").removeClass("popup-image")}});n(".form-get-your-copy").on("submit",function(n){n.preventDefault();window.open("../../404.html")});f=n(".prev-next-links");setTimeout(function(){f.fadeOut()},3e3)});n(window).load(function(){n(n(".ul-level1 > li")[4]).addClass("active");$viewport>=3&&affix()});n(window).scroll(function(){$viewport>=3?affix():resetAffix();var t=n(".prev-next-links");t.fadeIn();clearTimeout(s);s=setTimeout(function(){t.fadeOut()},3e3);window.innerHeight<window.innerWidth&&h&&r.length&&(f=n(window).scrollTop(),o=n("[data-scroll-top]",".block-contact-us").offset().top)})});$(function(){$("#submitButton").click(function(){var n=$("#Name").val().trim(),t=$("#Email").val().trim(),i=$("#Phone").val();if(validateForm(n,t,i)!=!1){var r=$("#Job").val(),u=$("#Organization").val(),f=$("#Location").val(),e=$("#Content").val();$.post("/api/ContactUsApi/Post",{Name:n,Job:r,Organization:u,Location:f,Phone:i,Email:t,Content:e},function(n){n==!0?(showPopupResult(SubcribeHeaderSuccess,SubcribeContentSuccess),$("#Name").val(""),$("#Job").val(""),$("#Organization").val(""),$("#Location").val(""),$("#Phone").val(""),$("#Email").val(""),$("#Content").val("")):showPopupResult(ErrorLabel,SubcribeContentError)})}})});$(function(){$("#btnDownloadForm").click(function(){var n=$("#Name").val()!=undefined?$("#Name").val().trim():"",t=$("#Email").val()!=undefined?$("#Email").val().trim():"",i=$("#Job").val()!=undefined?$("#Job").val().trim():"",r=$("#Organisation").val()!=undefined?$("#Organisation").val().trim():"",u,f;ValidateDownloadForm(n,i,r,t)!=!1&&(u=$("#PageIdValue").val(),f={Name:n,Job:i,Organisation:r,Email:t,PageId:u,PageUrl:$("#PageUrl").val(),PageTitle:$("#PageTitle").val()},$.ajax({url:"/api/FormApi/PostDownLoadForm",data:f,type:"POST",beforeSend:function(){},success:function(n){n.Result==!0?($("#Name").val(""),$("#Job").val(""),$("#Organisation").val(""),$("#Email").val(""),n.Data!=undefined&&n.Data!=""&&window.open(n.Data.Url)):showPopupResult(errorLabel,n.Message)},error:function(){showPopupResult(errorLabel,exceptionMessageGeneral)}}))})});$(function(){$("#txtEmail").keypress(function(n){(n.keyCode===10||n.keyCode===13)&&$("#btnSubcriber").click()});$("#btnSubcriber").click(function(){$.post("/api/FormApi/Post?email="+$("#txtEmail").val(),function(n){n.Result==!0?(showPopup("Success!",n.Message),$("#txtEmail").val("")):showPopup("Error!",n.Message)})})});jQuery(function(n){var t=n(window).width(),u=n(window).height(),f=null,o=null,h=navigator.userAgent.match(/iPad/i)!=null,i=n(".block-contact-us"),e=n("[data-accordion-handler]"),r=n("[data-collapse-handler]"),c=function(){var s=n(window).width(),h=n(window).height();(t!=s||u!=h)&&(t=s,u=h,$viewport=t<=479?0:t<=767?1:t<=991?2:t<=1199?3:t<=1300?4:5);$viewport<3?(n(".block-banner").css("padding-top",0),accordion(e),r.length&&accordion(r)):e.off("click.accordion");i.length&&t<u&&$viewport===2&&f!==null&&f+n("[data-scroll-top]",".block-contact-us").outerHeight(!0)>=o&&(i.hasClass("open")||n(".fancybox-overlay").length||i.find("[data-accordion-handler]").click())},s;n(window).bind("resize",c);n(document).ready(function(){var i,t;$viewport<3&&(accordion(e),r.length&&accordion(r));n(".form-contact").on("submit",function(n){n.preventDefault();showPopupResult("Your question has been submitted","We will send you an email notification once a doctor answers your query.")});i=n(".prev-next-links");setTimeout(function(){i.fadeOut()},3e3);n("[data-podcast]").each(function(){var t=n(this),i=t.data("podcast"),u=i.match(/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|\&v=|\?v=)([^#\&\?]*).*/),f=t.data("img"),e,r;u&&u[2].length===11?(e=i.replace("watch?v=","embed/index.html"),r=t.data("play")?"?autoplay=1":"",t.addClass("video-wrapper").html('<iframe width="100%" height="100%" src="'+e+r+'"  frameborder="0" allowfullscreen><\/iframe>')):(r=t.data("play")?"autoplay":"",i.match(/.mp3/)||i.match(/.m4a/)?t.addClass("audio").html('<div class="img"><img src="'+f+'" alt=""><\/div><audio '+r+' controls><source src="'+i+'" type="audio/mpeg"><\/audio>'):t.addClass("video").html("<video "+r+' controls poster="'+f+'"><source src="'+i+'" type="video/mp4"><\/video>'))});n("[data-podcast]").on("click",function(){var t=n(this),i=null;i=t.find("video").length?t.find("video"):t.find("audio");t.hasClass("play")?i[0].pause():i[0].play()});n("video, audio","[data-podcast]").each(function(){var t=n(this),i=t.parent();t[0].onplay=function(){playPause(i)};t[0].onpause=function(){playPause(i)}});t=n(".block-related");t.height()>n(".block-right").height()&&t.addClass("no-affix")});n(window).load(function(){n(n(".ul-level1 > li")[4]).addClass("active");$viewport>=3&&affix()});n(window).scroll(function(){$viewport>=3?affix():resetAffix();var t=n(".prev-next-links");t.fadeIn();clearTimeout(s);s=setTimeout(function(){t.fadeOut()},3e3);window.innerHeight<window.innerWidth&&h&&i.length&&(f=n(window).scrollTop(),o=n("[data-scroll-top]",".block-contact-us").offset().top)})});
//# sourceMappingURL=insightDetail.min.js.map
