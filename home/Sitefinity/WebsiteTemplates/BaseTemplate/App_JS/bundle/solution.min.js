 ...
 */
(function(n){"use strict";function f(n){return new RegExp("(^|\\s+)"+n+"(\\s+|$)")}function e(n,u){var f=t(n,u)?r:i;f(n,u)}var t,i,r,u;"classList"in document.documentElement?(t=function(n,t){return n.classList.contains(t)},i=function(n,t){n.classList.add(t)},r=function(n,t){n.classList.remove(t)}):(t=function(n,t){return f(t).test(n.className)},i=function(n,i){t(n,i)||(n.className=n.className+" "+i)},r=function(n,t){n.className=n.className.replace(f(t)," ")});u={hasClass:t,addClass:i,removeClass:r,toggleClass:e,has:t,add:i,remove:r,toggle:e};typeof define=="function"&&define.amd?define(u):n.classie=u})(window),function(){function n(n){classie.add(n.target.parentNode,"input--filled")}function t(n){n.target.value.trim()===""&&classie.remove(n.target.parentNode,"input--filled")}String.prototype.trim||function(){var n=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g;String.prototype.trim=function(){return this.replace(n,"")}}();[].slice.call(document.querySelectorAll("input.input__field")).forEach(function(i){i.value.trim()!==""&&classie.add(i.parentNode,"input--filled");i.addEventListener("focus",n);i.addEventListener("blur",t)})}();"use strict";var caseSlider=null,blueImpactSlider=null,pagerSlider=null,controlSlider=null;jQuery(function(n){function c(){var t=n("#slideCaseStudy").children().length;t>1&&(caseSlider=n("#slideCaseStudy").bxSlider({controls:!1}))}function u(t,i){var r=n("#slideBlueImpact").children().length<2;blueImpactSlider=n("#slideBlueImpact").bxSlider({pager:r?!1:t?!0:!1,controls:r?!1:i?!0:!1,auto:!0,pause:15e3,speed:1e3,hideControlOnEnd:!0,adaptiveHeight:!0,touchEnabled:r?!1:!0,onSlideAfter:function(){blueImpactSlider.stopAuto();blueImpactSlider.startAuto()}})}function f(t,i){t.off("click.accordion").on("click.accordion",function(){var o=n(this),s=t.selector,u=s.split("-")[1],r=o.closest("[data-"+u+"]"),f=r.find("[data-"+u+"-content]"),e;f.is(":visible")?(r.removeClass("open"),f.slideUp(600)):(e=n("[data-"+u+"].open"),e.length?e.find("[data-"+u+"-content]").slideUp(300,function(){e.removeClass("open");r.addClass("open");f.slideDown(600)}):(r.addClass("open"),f.slideDown(600)),setTimeout(function(){n("body, html").animate({scrollTop:o.offset().top-(n("#header").outerHeight(!0)+10)},600)},600),r.find("[data-slider]").length&&setTimeout(function(){caseSlider?caseSlider.reloadSlider():i();blueImpactSlider?blueImpactSlider.reloadSlider():i()},600))})}var t=n(window).width(),i=n(window).height(),s,h=null,l=null,a=navigator.userAgent.match(/iPad/i)!=null,e=n(".block-contact-us"),o=n("[data-accordion-handler]"),r=n("[data-collapse-handler]"),v=function(){var a=n(window).width(),v=n(window).height();(t!=a||i!=v)&&(t=a,i=v,$viewport=t<=479?0:t<=767?1:t<=991?2:t<=1199?3:t<=1300?4:5,blueImpactSlider&&n.isFunction(blueImpactSlider.destroySlider)&&(blueImpactSlider.destroySlider(),blueImpactSlider=null),s!==$viewport&&($viewport>2?caseSlider&&n.isFunction(caseSlider.destroySlider)&&(caseSlider.destroySlider(),caseSlider=null):caseSlider!==null&&n.isFunction(caseSlider.destroySlider)||c()),$viewport<3?(n(".block-impact").hasClass("open")?(pagerSlider=!0,controlSlider=!1,u(pagerSlider,controlSlider),f(o)):f(o,function(){caseSlider&&n.isFunction(caseSlider.destroySlider)&&(caseSlider.destroySlider(),caseSlider=null);pagerSlider=!0;controlSlider=!1;u(pagerSlider,controlSlider);c()}),r.length&&f(r),n("[data-scroll-space]").css("padding-top",0)):(pagerSlider=!1,controlSlider=!0,u(pagerSlider,controlSlider),o.off("click.accordion"),r.off("click.accordion")),e.length&&t<i&&$viewport===2&&h!==null&&h+n('[data-scroll-top="contactus"]').outerHeight(!0)>=l&&(e.hasClass("open")||e.find("[data-accordion-handler]").click()),s=$viewport)};n(window).bind("resize",v);n(document).ready(function(){var h,e;if(n(n(".ul-level1 > li")[2]).addClass("active"),s=$viewport,$viewport<3?(f(o,function(){caseSlider&&n.isFunction(caseSlider.destroySlider)&&(caseSlider.destroySlider(),caseSlider=null);blueImpactSlider&&n.isFunction(blueImpactSlider.destroySlider)&&(blueImpactSlider.destroySlider(),blueImpactSlider=null);pagerSlider=!0;controlSlider=!1;c();u(pagerSlider,controlSlider)}),r.length&&f(r)):(pagerSlider=!1,controlSlider=!0,u(pagerSlider,controlSlider)),n("[data-fancybox]").fancybox({helpers:{title:null},beforeShow:function(){n("html").addClass("popup-image");isMobile.phone&&(this.width=t<i?i:t,n(".fancybox-inner").height("auto"))},afterShow:function(){},afterClose:function(){n("html").removeClass("popup-image")}}),h=n(".block-impact"),h.length){var l=n(".title",h).text(),y=n(".casestudy-wrapper"),p=n(".case-showcase",y),w=n(".case-impact"),a=n("p",h).text(),v=n("ul li",w);l.length>1||p.length||v.length||a.length>1?h.css("display","block"):h.remove()}if(e=n(".block-insights-solution"),e.length){var l=n(".title",e).text(),a=n("p",e).text(),v=n(".grid-item",e);l.length>1||v.length||a.length>1?e.css("display","block"):e.remove()}});n(window).load(function(){var t=n(".block-sticky-nav"),i,u;if(t.length){t.affix({offset:{top:n(".sticky-nav").offset().top}});t.on("affixed-top.bs.affix",function(){n("[data-scroll-space]").css("padding-top",0)});t.on("affix.bs.affix",function(){n("[data-scroll-space]").css("padding-top",t.outerHeight(!0))})}i=t.find("li");u=i.find("a");i.width(100/i.length+"%");i.on("click",function(){var u=n(this),i=u.find("a").attr("href"),f=i.split("#")[1],r=0;t.length&&(r=t.outerHeight(!0)+10);window.location.hash=i;n("body, html").stop().animate({scrollTop:n('[data-scroll-top="'+f+'"]').offset().top-r},600)});var r=window.location.hash,t=n(".block-sticky-nav"),f=t.outerHeight(!0),e=n('[data-scroll-top="'+r.split("#")[1]+'"]');t.is(":visible")&&e.length&&setTimeout(function(){n("html, body").animate({scrollTop:n('[data-scroll-top="'+r.split("#")[1]+'"]').offset().top-f-10})},600)});n(window).scroll(function(){var t=n(".block-sticky-nav"),r=t.find("a","li"),i=n(window);t.length&&n("[data-scroll-top]").each(function(){var u=n(this),f=r.filter('[href="#'+u.data("scroll-top")+'"]');(i.scrollTop()+i.height()==n(document).height()||i.scrollTop()>=u.offset().top-t.outerHeight(!0)*2)&&f.closest("li").addClass("active").siblings().removeClass("active")});window.innerHeight<window.innerWidth&&a&&e.length&&(h=n(window).scrollTop(),l=n("[data-scroll-top]",".block-contact-us").offset().top)})});$(window).load(function(){if(serviceType!=undefined){var n="/api/ServicesApi/GetServices?type="+serviceType+"&pageNodeId="+pageNodeId;$.post(n,function(n){$("#gridservices").html(n);$("#gridservices").is(":empty")&&$("#idservices")!=undefined&&$("#idservices").hide()})}});$(function(){$("#submitButton").click(function(){var n=$("#Name").val().trim(),t=$("#Email").val().trim(),i=$("#Phone").val();if(validateForm(n,t,i)!=!1){var r=$("#Job").val(),u=$("#Organization").val(),f=$("#Location").val(),e=$("#Content").val();$.post("/api/ContactUsApi/Post",{Name:n,Job:r,Organization:u,Location:f,Phone:i,Email:t,Content:e},function(n){n==!0?(showPopupResult(SubcribeHeaderSuccess,SubcribeContentSuccess),$("#Name").val(""),$("#Job").val(""),$("#Organization").val(""),$("#Location").val(""),$("#Phone").val(""),$("#Email").val(""),$("#Content").val("")):showPopupResult(ErrorLabel,SubcribeContentError)})}})});
//# sourceMappingURL=solution.min.js.map
