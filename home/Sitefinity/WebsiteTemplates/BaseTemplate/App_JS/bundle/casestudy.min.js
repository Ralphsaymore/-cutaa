 ...
 */
(function(n){"use strict";function f(n){return new RegExp("(^|\\s+)"+n+"(\\s+|$)")}function e(n,u){var f=t(n,u)?r:i;f(n,u)}var t,i,r,u;"classList"in document.documentElement?(t=function(n,t){return n.classList.contains(t)},i=function(n,t){n.classList.add(t)},r=function(n,t){n.classList.remove(t)}):(t=function(n,t){return f(t).test(n.className)},i=function(n,i){t(n,i)||(n.className=n.className+" "+i)},r=function(n,t){n.className=n.className.replace(f(t)," ")});u={hasClass:t,addClass:i,removeClass:r,toggleClass:e,has:t,add:i,remove:r,toggle:e};typeof define=="function"&&define.amd?define(u):n.classie=u})(window),function(){function n(n){classie.add(n.target.parentNode,"input--filled")}function t(n){n.target.value.trim()===""&&classie.remove(n.target.parentNode,"input--filled")}String.prototype.trim||function(){var n=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g;String.prototype.trim=function(){return this.replace(n,"")}}();[].slice.call(document.querySelectorAll("input.input__field")).forEach(function(i){i.value.trim()!==""&&classie.add(i.parentNode,"input--filled");i.addEventListener("focus",n);i.addEventListener("blur",t)})}();jQuery(function(n){var t=n(window).width(),i=n(window).height(),e=null,o=null,s=navigator.userAgent.match(/iPad/i)!=null,r=n(".block-contact-us"),u=n("[data-accordion-handler]"),f=n("[data-collapse-handler]"),h=function(){var s=n(window).width(),h=n(window).height();(t!=s||i!=h)&&(t=s,i=h,$viewport=t<=479?0:t<=767?1:t<=991?2:t<=1199?3:t<=1300?4:5);$viewport<3?(n("[data-scroll-space]").css("padding-top",0),accordion(u),f.length&&accordion(f),n(".group-item").height("auto")):(u.off("click.accordion"),f.off("click.accordion"),n(".group-item").setAllToMaxHeight());r.length&&t<i&&$viewport===2&&e!==null&&e+n('[data-scroll-top="contactus"]').outerHeight(!0)>=o&&(r.hasClass("open")||r.find("[data-accordion-handler]").click())};n(window).bind("resize",h);n(document).ready(function(){var r,e,o;if($viewport<3?(accordion(u),f.length&&accordion(u)):n(n(".ul-level1 > li")[4]).addClass("active"),r=n(".block-sticky-nav"),r.length){r.affix({offset:{top:n(".sticky-nav").offset().top}});r.on("affixed-top.bs.affix",function(){n("[data-scroll-space]").css("padding-top",0)});r.on("affix.bs.affix",function(){n("[data-scroll-space]").css("padding-top",r.outerHeight(!0))})}e=r.find("li");o=e.find("a");e.width(100/e.length+"%");e.on("click",function(){var i=n(this),t=i.find("a").attr("href"),u=t.split("#")[1];window.location.hash=t;n("body, html").stop().animate({scrollTop:n('[data-scroll-top="'+u+'"]').offset().top-r.outerHeight(!0)-10},600)});n("[data-fancybox]").fancybox({helpers:{title:null},beforeShow:function(){n("html").addClass("popup-image");isMobile.phone&&(this.width=t<i?i:t,n(".fancybox-inner").height("auto"))},afterShow:function(){},afterClose:function(){n("html").removeClass("popup-image")}});n(".form-contact").on("submit",function(n){n.preventDefault();showPopupResult("Your question has been submitted","We will send you an email notification once a doctor answers your query.")})});n(window).load(function(){n(n(".ul-level1 > li")[4]).addClass("active");$viewport>2&&n(".group-item").setAllToMaxHeight();var t=window.location.hash,i=n(".block-sticky-nav"),r=i.outerHeight(!0),u=n('[data-scroll-top="'+t.split("#")[1]+'"]');i.is(":visible")&&u.length&&setTimeout(function(){n("html, body").animate({scrollTop:n('[data-scroll-top="'+t.split("#")[1]+'"]').offset().top-r-10})},600)});n(window).on("scroll",function(){var t=n(".block-sticky-nav"),u=t.find("a","li"),i=n(window);t.length&&n("[data-scroll-top]").each(function(){var r=n(this),f=u.filter('[href="#'+r.data("scroll-top")+'"]');(i.scrollTop()+i.height()==n(document).height()||i.scrollTop()>=r.offset().top-t.outerHeight(!0)*2)&&f.closest("li").addClass("active").siblings().removeClass("active")});window.innerHeight<window.innerWidth&&s&&r.length&&(e=n(window).scrollTop(),o=n("[data-scroll-top]",".block-contact-us").offset().top)})});$(window).load(function(){if(serviceType!=undefined){var n="/api/ServicesApi/GetServices?type="+serviceType+"&pageNodeId="+pageNodeId;$.post(n,function(n){$("#gridservices").html(n);$("#gridservices").is(":empty")&&$("#idservices")!=undefined&&$("#idservices").hide()})}});$(function(){$("#submitButton").click(function(){var n=$("#Name").val().trim(),t=$("#Email").val().trim(),i=$("#Phone").val();if(validateForm(n,t,i)!=!1){var r=$("#Job").val(),u=$("#Organization").val(),f=$("#Location").val(),e=$("#Content").val();$.post("/api/ContactUsApi/Post",{Name:n,Job:r,Organization:u,Location:f,Phone:i,Email:t,Content:e},function(n){n==!0?(showPopupResult(SubcribeHeaderSuccess,SubcribeContentSuccess),$("#Name").val(""),$("#Job").val(""),$("#Organization").val(""),$("#Location").val(""),$("#Phone").val(""),$("#Email").val(""),$("#Content").val("")):showPopupResult(ErrorLabel,SubcribeContentError)})}})});
